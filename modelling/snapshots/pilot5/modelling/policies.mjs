...
import {labChoose,LAB_POLICIES} from './lab-policies.mjs';
import {
  act,
...
export const POLICY_NAMES = ["random", "greedy", "spender", "rollout", "builder", "specialist", ...RESEARCH_POLICIES,...LAB_POLICIES];
...
export function makePolicy(
  ...
  return {
    ...
    choose(view) {
      decisions++;
      if(LAB_POLICIES.includes(name))return labChoose(name,view,privateRandom);
